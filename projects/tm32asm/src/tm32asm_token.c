...
static const TM32ASM_Token KEYWORD_LOOKUP[] = {
    ...
    { "int",            TM32ASM_TT_FUNCTION,        TM32ASM_FT_INTEGER,     NULL, 0 },
    { "fraction",       TM32ASM_TT_FUNCTION,        TM32ASM_FT_FRACTION,    NULL, 0 },
    { "frac",           TM32ASM_TT_FUNCTION,        TM32ASM_FT_FRACTION,    NULL, 0 },
    ...
    { "atan2",          TM32ASM_TT_FUNCTION,        TM32ASM_FT_ATAN2,       NULL, 0 },
    { "strlen",         TM32ASM_TT_FUNCTION,        TM32ASM_FT_STRLEN,      NULL, 0 },
    { "strupper",       TM32ASM_TT_FUNCTION,        TM32ASM_FT_STRUPPER,    NULL, 0 },
    { "strupr",         TM32ASM_TT_FUNCTION,        TM32ASM_FT_STRUPPER,    NULL, 0 },
    { "strlower",       TM32ASM_TT_FUNCTION,        TM32ASM_FT_STRLOWER,    NULL, 0 },
    { "strlwr",         TM32ASM_TT_FUNCTION,        TM32ASM_FT_STRLOWER,    NULL, 0 },
    { "strcat",         TM32ASM_TT_FUNCTION,        TM32ASM_FT_STRCAT,      NULL, 0 },
    ...
    { "isvar",          TM32ASM_TT_FUNCTION,        TM32ASM_FT_ISVARIABLE,  NULL, 0 },
